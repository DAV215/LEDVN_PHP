function show_post_category(category, page) {
    $(".post_list_2").empty();
    $(".more_post").empty();
    $.ajax({
...
var post_category = idMatch ? decodeURIComponent(idMatch[1]) : null;
show_post_category(post_category, 1);