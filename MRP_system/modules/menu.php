...
<div class="sidebar_menu">
    <div class="main_menu">
        ...
        <li>
            <a href="mrp_index.php?action=quanlyphongban&query=them">Quản lý phòng ban</a>
        </li>
        
        <li>
            <a href="mrp_index.php?action=quanlyphanquyen&query=lietke">Quản lý phân quyền</a>
        </li>
        <li>
            <a href="mrp_index.php?action=quanlynhanvien&query=lietke">Quản lý nhân viên</a>
            <div class="child_menu">
                <a href="mrp_index.php?action=quanlynhanvien&query=them">Thêm nhân viên</a>
                <a href="mrp_index.php?action=quanlynhanvien&query=lietke">Liệt kê</a>
            </div>
        </li>
        <!-- <li>
